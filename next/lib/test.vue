...
const defaultCropperProps: Required<InterfaceVueCropperProps> = {
  img: '',
  wrapper: {
    width: '100%',
    height: '100%',
...
<template>
  ...
  >
    <section v-if="img" class="cropper-box cropper-fade-in">
      ...
      <section :class="computedClassDrag()" ref="cropperImg" />
        <section v-if="cropping"  class="cropper-crop-box" :style="getCropBoxStyle()">
          <span class="cropper-view-box">
            <img :src="imgs" :style="getCropImgStyle()" alt="cropper-img" />
          </span>
